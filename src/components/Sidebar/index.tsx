    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2">
          <Link href="/">
            <Image
              width={120} // Adjusted width for responsiveness
              height={120} // Adjusted height for responsiveness
              src={"/images/logo/logo.svg"}
              alt="Logo"
              className="w-auto h-auto max-h-16 lg:max-h-24 object-contain ml-10 -mb-8" // Ensure responsive sizing
              priority
            />
          </Link>
